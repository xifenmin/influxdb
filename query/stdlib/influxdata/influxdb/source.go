...
func ReadFilterSource(id execute.DatasetID, r query.Reader, readSpec query.ReadFilterSpec, a execute.Administration) execute.Source {
...
func ReadGroupSource(id execute.DatasetID, r query.Reader, readSpec query.ReadGroupSpec, a execute.Administration) execute.Source {
...
func ReadTagKeysSource(id execute.DatasetID, r query.Reader, readSpec query.ReadTagKeysSpec, a execute.Administration) execute.Source {
...
func ReadTagValuesSource(id execute.DatasetID, r query.Reader, readSpec query.ReadTagValuesSpec, a execute.Administration) execute.Source {
